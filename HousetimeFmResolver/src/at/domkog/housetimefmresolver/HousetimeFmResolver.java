package at.domkog.housetimefmresolver;
 ...
 */
public class HousetimeFmResolver extends StationDataResolver {
    ...
    public StationData fetchData() {
        ...
        try {
            ...
            data.title = xpath.evaluate("//radio[name='HouseTime']/song", doc);
            data.artist = xpath.evaluate("//radio[name='HouseTime']/artist", doc);
